...
execute if score @s trueEnding_bosstime matches 1521..1599 if score @s trueEnding_y matches ..84 run tp @s 0 85 0
execute if score @s trueEnding_bosstime matches 1521..1599 if score @s trueEnding_y matches 85.. run tp @s 0 ~ 0
